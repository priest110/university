...
#define BLOCKSIZE 16
#define SIZE 2048   // Nº de linhas e Nº de colunas da matriz
#define NUM_EVENTS 4
...
// Implementação i-j-k (2.2) (NÃO VETORIZA)
...
// Implementação i-j-k transposta (VETORIZA)
...
// Implementação i-k-j (2.3.1) (VETORIZA)
...
// Implementação j-k-i (2.3.2) (NÃO VETORIZA)
...
// Implementação j-k-i transposta (VETORIZA)
...
// Implementação i-j-k por Blocos (NÃO VETORIZA)
...
// Implementação i-j-k por Blocos com a Transposta (VETORIZA)
...
// Implementação j-k-i por Blocos com a Transposta (VETORIZA)
...
int main(int argc, char const *argv[]){
    ...
    long long unsigned t1,t2,t3,t4,t5,t6,t7,t8;
    cout <<"Vec"<< endl;
