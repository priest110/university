 ...
 */
public class CarroGasoleo extends Veiculo implements Serializable{
     ...
     */
    public CarroGasoleo(String m, double v, double p, List<Aluguer> al, double cla, double tf, double x, double y, boolean d, double con, double com, double comm){
     ...
     */
    public CarroGasoleo(CarroGasoleo v){
        super(v);
     ...
     */
    public CarroGasoleo clone(){
        return new CarroGasoleo(this);
    }
